...
GIZA_BIN_DIR='/home/mazhang/inverse-text-normailzation/giza-pp/GIZA++-v2'
## path to MCKLS_BINARY, e.g. /home/user/giza-pp/mkcls-v2/mkcls
MCKLS_BINARY='/home/mazhang/inverse-text-normailzation/giza-pp/mkcls-v2/mkcls'
## initial unzipped Google Text Normalization Dataset, e.g. /home/user/data/en_with_types
GOOGLE_CORPUS_DIR='/home/mazhang/inverse-text-normailzation/GTN_ini/'
